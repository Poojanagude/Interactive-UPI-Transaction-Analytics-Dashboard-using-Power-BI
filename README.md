...
Analyze bank-wise transactions
Filter data dynamically
Improve dashboard interactivity
Enable business users to make faster decisions
Tools Used
Power BI Desktop
Power Query
DAX
...
Conditional formatting highlights high-value transactions.
Interactive slicers allow quick comparison across cities, banks, and payment methods.
